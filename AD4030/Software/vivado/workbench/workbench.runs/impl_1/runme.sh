...
HD_PWD='/home/grzegorz/git/ARTY_Z7/AD4030/Software/vivado/workbench/workbench.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AD4030_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AD4030_BD_wrapper.tcl -notrace
