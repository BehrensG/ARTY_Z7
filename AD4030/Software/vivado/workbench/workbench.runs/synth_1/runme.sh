...
HD_PWD='/home/grzegorz/git/ARTY_Z7/AD4030/Software/vivado/workbench/workbench.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AD4030_BD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AD4030_BD_wrapper.tcl
