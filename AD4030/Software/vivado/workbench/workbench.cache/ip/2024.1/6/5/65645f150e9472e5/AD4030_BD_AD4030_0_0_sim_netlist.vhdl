...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AD4030_FIFO is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_spi_state[0]_i_6\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \count_var[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \count_var[6]_i_2\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of memory_reg_i_3 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \rd_ptr[4]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \spi_bit_count[4]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \spi_bit_count[5]_i_4\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \wr_ptr[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \wr_ptr[4]_i_1\ : label is "soft_lutpair4";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pulse_generator is
  ...
  attribute SOFT_HLUTNM of pulse_period_cnt0_carry_i_11 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of pulse_period_cnt0_carry_i_12 : label is "soft_lutpair9";
...
pulse_out_reg_i_12: unisim.vcomponents.LUT6
    generic map(
...
\pulse_period_cnt0_carry__6_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FEFF"
    )
        port map (
      ...
      I3 => \pulse_period_reg_out_reg_n_0_[31]\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ad4030_spi is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_spi_state[0]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \FSM_sequential_spi_state[0]_i_4\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \FSM_sequential_spi_state[0]_i_5\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \FSM_sequential_spi_state[1]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of ad4030_cfg_enabled_reg_i_15 : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of ad4030_cfg_enabled_reg_i_16 : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of ad4030_cfg_mode_i_2 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of ad4030_cs_n_i_1 : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \ad4030_readout_reg[31]_i_3\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \ad4030_spi_status[0]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \ad4030_spi_status[1]_i_2\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \ad4030_spi_status[2]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of axi_bvalid_i_3 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of baud_clk_i_1 : label is "soft_lutpair22";
  attribute METHODOLOGY_DRC_VIOS : string;
  ...
  attribute SOFT_HLUTNM of \cnv_period_cfg[31]_i_2\ : label is "soft_lutpair17";
  attribute ADDER_THRESHOLD : integer;
  ...
  attribute SOFT_HLUTNM of mosi_data_update_i_1 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of mosi_out_INST_0 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of sclk_out_INST_0 : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \spi_bit_count[3]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \spi_bit_count[3]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \spi_bit_count[4]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \spi_bit_count[4]_i_4\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \spi_bit_count[5]_i_5\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \spi_bit_count[5]_i_6\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \spi_bit_count[5]_i_7\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \spi_cfg[31]_i_2\ : label is "soft_lutpair17";
begin
...
ad4030_cfg_enabled_reg_i_10: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
ad4030_cfg_enabled_reg_i_16: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
    )
        port map (
...
ad4030_cfg_enabled_reg_i_2: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => ad4030_cfg_enabled_reg_i_6_n_0,
      I2 => ad4030_cfg_enabled_reg_i_8_n_0,
      I3 => ad4030_cfg_enabled_reg_i_4_n_0,
      O => ad4030_cfg_enabled_reg_i_2_n_0
    );
ad4030_cfg_enabled_reg_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0002"
    )
        port map (
...
ad4030_cfg_enabled_reg_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0DFF"
    )
        port map (
...
cfg_fifo: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AD4030_FIFO
     port map (
      ...
      \FSM_sequential_spi_state_reg[1]\ => cfg_fifo_n_1,
      \FSM_sequential_spi_state_reg[2]\ => cfg_fifo_n_4,
      ...
      axi4l_wdata_sig => axi4l_wdata_sig,
      baud_clk => baud_clk,
      baud_clk_reg => cfg_fifo_n_2,
      baud_clk_reg_0 => cfg_fifo_n_3,
      clk_in => clk_in,
