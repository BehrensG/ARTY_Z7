...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/ec67/hdl" +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/b28c/hdl" +incdir+"/opt/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/ec67/hdl" +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/b28c/hdl" +incdir+"/opt/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/ec67/hdl" +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/b28c/hdl" +incdir+"/opt/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_17 $vlogan_opts -sverilog +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/ec67/hdl" +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/b28c/hdl" +incdir+"/opt/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_19 $vlogan_opts -sverilog +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/ec67/hdl" +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/b28c/hdl" +incdir+"/opt/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/ec67/hdl" +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/b28c/hdl" +incdir+"/opt/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/ec67/hdl" +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/b28c/hdl" +incdir+"/opt/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/ec67/hdl" +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/b28c/hdl" +incdir+"/opt/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_data_fifo_v2_1_30 $vlogan_opts +v2k +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/ec67/hdl" +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/b28c/hdl" +incdir+"/opt/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/ec67/hdl" +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/b28c/hdl" +incdir+"/opt/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_protocol_converter_v2_1_31 $vlogan_opts +v2k +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/ec67/hdl" +incdir+"../../../../ThreadX.gen/sources_1/bd/ThreadX/ipshared/b28c/hdl" +incdir+"/opt/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ThreadX xil_defaultlib.glbl -o ThreadX_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ThreadX_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/grzegorz/git/ARTY_Z7/ThreadX/ThreadX.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key ThreadX_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ThreadX_simv.daidir vcs_lib c.obj)
