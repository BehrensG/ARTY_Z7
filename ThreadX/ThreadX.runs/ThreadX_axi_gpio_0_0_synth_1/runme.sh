...
HD_PWD='/home/grzegorz/git/ARTY_Z7/ThreadX/ThreadX.runs/ThreadX_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ThreadX_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ThreadX_axi_gpio_0_0.tcl
