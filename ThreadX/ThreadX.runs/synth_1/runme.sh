...
HD_PWD='/home/grzegorz/git/ARTY_Z7/ThreadX/ThreadX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ThreadX_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ThreadX_wrapper.tcl
