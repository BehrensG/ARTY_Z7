...
HD_PWD='/home/grzegorz/git/ARTY_Z7/ThreadX/ThreadX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ThreadX_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ThreadX_wrapper.tcl -notrace
